...
export function ActivityLogPage() {
  ...
  if (q.isError)
    return <div className="text-(--color-danger)">Failed to load logs</div>;
            ...
            {filtered.map((row, i) => {
              ...
              return (
                <div key={i} className="relative pb-6 last:pb-0">
                  <span className="absolute top-0.5 -left-[33px] flex h-4 w-4 items-center justify-center rounded-full border-2 border-(--color-border) bg-(--color-surface)">
